...
export function AssessmentScreen() {
  ...
  const score = done
    ? Math.round(
        (answers.filter((a, i) => a === JAVA_QUESTIONS[i].ans).length /
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            {answers.filter((a, i) => a === JAVA_QUESTIONS[i].ans).length} of{" "}
            {JAVA_QUESTIONS.length} correct
          </p>
          ...
          >
            ...
            <Button
              ...
              onClick={() => {
                setDone(false);
                setCurrent(0);
                setAnswers(Array(JAVA_QUESTIONS.length).fill(null));
                setTimeLeft(25 * 60);
    ...
    >
        ...
        >
          ...
          <div
            style={{
              ...
              padding: "6px 14px",
              borderRadius: 10,
              background: timeLeft < 300 ? C.roseL : C.amberL,
              color: timeLeft < 300 ? C.rose : C.amber,
              fontWeight: 700,
              fontSize: 14,
      ...
      {showConfirm && (
        ...
        >
          ...
          >
            ...
            >
              You have answered {answers.filter((a) => a !== null).length} of{" "}
              {JAVA_QUESTIONS.length} questions. Submit now?
            </p>
            ...
            >
              <Button variant="ghost" full onClick={() => setShowConfirm(false)}>
                Go Back
              </Button>
      ...
      >
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <ProgressBar
            value={((current + 1) / JAVA_QUESTIONS.length) * 100}
            color={C.purple}
            height={4}
          />
        </div>
          ...
          {JAVA_QUESTIONS.map((_, i) => (
            <button
              ...
              style={{
                ...
                borderRadius: 8,
                border: `1.5px solid ${
                  i === current ? C.purple : answers[i] !== null ? C.green : C.border
                }`,
                background:
                  i === current ? C.purple : answers[i] !== null ? C.greenL : "#fff",
                color: i === current ? "#fff" : answers[i] !== null ? C.green : C.muted,
                fontSize: 11,
                fontWeight: 700,
                cursor: "pointer",
              }}
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    background: sel ? C.purpleXL : "#FAFBFE",
                    cursor: "pointer",
                    textAlign: "left",
        ...
        >
          ...
          {isLast ? (
            ...
            <Button
              onClick={() =>
                setCurrent((c) => Math.min(JAVA_QUESTIONS.length - 1, c + 1))
              }
            >
